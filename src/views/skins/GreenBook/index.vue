              ...
              <div class="item-title">
                <router-link :to="item.url">
                  ...
                  <span style="padding-right:10px" v-if="item.isTop">
                    <svg style="margin-bottom: -1px;" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"
                         width="20" height="20">
                      <path :d="topIcon.d" fill="#f05f6c"></path>
                    </svg>
                  </span>
...
<script>
  ...
  import PageNav from "@/views/skins/Nexmoe/page-nav";

  // console.log(window.location)
  export default {
    name: "index",
    components: {PageNav, LayoutSlot, VueHeader, VueFooter},
    data() {
      return {
        topIcon: {
