export default [
  ...
  // {path: "/article-detail/:id", component: () => import('@/views/skins/Nexmoe/article.vue')},
  {path: "/links", component: () => import('@/views/skins/Nexmoe/links.vue')},
  // {path: "/movies", component: () => import('@/views/skins/Nexmoe/movies.vue')},
  // {path: "/photos", component: () => import('@/views/skins/Nexmoe/photos.vue')},
  // {path: "/cross", component: () => import('@/views/skins/Nexmoe/links.vue')},
]
